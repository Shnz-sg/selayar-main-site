      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-300 leading-relaxed">
            Selayar Global is a maritime-focused organization with deep operational understanding and a commitment to modernizing the industry through intelligent digital solutions.
          </p>
        </motion.div>
      </div>
