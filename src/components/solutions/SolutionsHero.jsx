      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-300 leading-relaxed">
            From operational consultancy to digital transformation, we provide end-to-end solutions designed to modernize maritime operations and drive measurable improvements.
          </p>
        </motion.div>
      </div>
